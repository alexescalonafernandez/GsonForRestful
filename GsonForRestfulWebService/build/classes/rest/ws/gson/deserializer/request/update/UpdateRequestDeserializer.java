 ...
 */
public class UpdateRequestDeserializer extends RequestDeserializer{

    public UpdateRequestDeserializer(EntityManager entityManager, UriInfo uriInfo, ServletContext servletContext) {
    ...
    public Message getResponse(JsonElement je, Type type, JsonDeserializationContext jdc) {
        ...
        return buildUpdateEntityRequestDeserializer(
